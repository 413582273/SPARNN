...
for q in range(300):
    print(q)
    #得到训练数据集
    dataX, dataY = creat_dataset(uu_noise,q*predstep,trainstep,predstep)  #第一维是x 第二维是t
    x_train = dataX #训练数据
    ...
    #准备测试数据
    #得到用于验证的数据集
    dataX, dataY = creat_dataset(uu_noise,(q+1)*predstep,trainstep,predstep)  #第一维是x 第二维是t
